...
import HowToMeet from "../../components/HowToMeet";
...
function Vibe(){
  ...
  const navigation = useNavigation();
    ...
    <View style={styles.container}>
      ...
      <LinearGradient colors={colors} style={[styles.cardWrapper,styles.shadowProp]}>
...
const colors = ['#08096F', '#0D0D0D' ,Theme.backgroundColor ,Theme.backgroundColor, '#1B1D8B',]